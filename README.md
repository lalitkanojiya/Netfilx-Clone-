...
Clone of the Netflix website as a light HTML CSS and JS excercise - [Take a look](https://cheery-dragon-919608.netlify.app/)

[![Practice](https://img.shields.io/badge/Practice-HTML/CSS/JS-orange.svg)](https://github.com/lalitkanojiya?tab=repositories)
...
- Many thanks to [@anandpratiksha](https://github.com/anandpratiksha) for his awesome courses - _i will not fail you sensei_
- Thanks to [@mehulvaddepalli](https://github.com/mehulvaddepalli) For Making the world a better place
